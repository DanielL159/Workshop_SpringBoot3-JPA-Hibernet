...
import com.Daniel.aulaJavaBoot.services.CategoryService;


@RestController//Indica que e um recurso web que e implementado por um controlador reste
@RequestMapping(value = "/categories")//Da nome ao recurso
public class CategoryResource {
	...
	public ResponseEntity<List<Category>> findAll(){ //ResponseEntity e um tipo especifico do spring para retornar resposta de requisiçoes web
